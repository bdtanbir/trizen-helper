...
jQuery(function ($) {
    ...
    var HotelCalendar = function (container) {
        ...
        this.fullCalendarOptions = {
            ...
            select: function ({
                ...
                if(moment(start).isBefore(moment(), 'day') || moment(end).isBefore(moment(), 'day')) {
                    ...
                    setCheckInOut("", "", self.form_contaienr)
                } else {
                    ...
                    setCheckInOut(check_in, check_out, self.form_contaienr);
                }
            },
            events: function ({
                start,
                ...
                if(arg.event.extendedProps.status) {
                    ...
                    if (status === 'unavailable') {
                        ...
                        if(typeof args.event.extendedProps.price != 'undefined') {
                            ...
                            basePriceEl.innerHTML = ts_params.text_price + args.event.extendedProps.price;
            ...
            eventClick: function ({
                ...
                if(typeof event.extendedProps.price != 'undefined') {
                    $("#calendar_price", self.form_contaienr).val(event.extendedProps.price);
                }
        ...
        this.init = function () {
            ...
            self.form_contaienr = $('.calendar-form', self.container);
            setCheckInOut('', '', self.form_contaienr);
            self.initCalendar();
        }
    ...
    $(function () {
        $('.calendar-wrapper').each(function (index, el) {
            ...
            $('body').on('calendar.change_month', function (event, value) {
                if (hotel.fullCalendar) {
                    var date =  hote.fullCalendar.getData();
