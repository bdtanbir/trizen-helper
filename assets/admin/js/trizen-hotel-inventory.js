...
;(function ($, window, document) {
    ...
    $(function () {
        ...
        var form = $('.ts-inventory-form');
        var check_out = $('.ts-inventory-end', form).daterangepicker({
            language: ts_params.locale || '',
            dateFormat: 'yy-mm-dd',
            autoUpdateInput: true,
            singleDatePicker: true,
        });
        var check_in = $('.ts-inventory-start', form).daterangepicker({
            language: ts_params.locale || '',
            dateFormat: 'yy-mm-dd',
            autoUpdateInput: true,
            singleDatePicker: true,
            onSelect  : function (selected) {
                ...
                check_out.daterangepicker("option", "minDate", selected);
                window.setTimeout(function () {
                    check_out.daterangepicker("show");
                }, 100);
            }
        });
